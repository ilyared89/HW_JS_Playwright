# Привет! Меня зовут Илья Поединков
...
### Я ручной тестировщик с опытом в автоматизации тестирования
...
|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|-------------|
| [![РСХБ-Экосистема](https://rshbdigital.ru/img/logo_a.svg)](https://rshbdigital.ru/rshb-eco)   <br> **Ведущий инженер по ручному тестирования** | 2025 - ... |
| [![РСХБ-Интех](https://rshbdigital.ru/img/logo_a.svg)](<(https://rshbdigital.ru/rshb-intech)>)   <br>**Ведущий инженер по ручному тестирования** | 2022 - 2025 |
